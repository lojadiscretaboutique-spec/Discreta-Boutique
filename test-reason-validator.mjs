import { runReasonValidatorTests } from './src/services/pdvDiscountReasonValidator.ts';

console.log('--- EXECUTANDO TESTES DO VALIDADOR DE MOTIVO E OBSERVAÇÃO ---');
const report = runReasonValidatorTests();
