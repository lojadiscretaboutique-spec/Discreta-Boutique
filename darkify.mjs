...
const replacements = [
    ...
    { regex: /\bbg-slate-100\/50\b/g, replacement: 'bg-slate-900/50' },
    { regex: /\bbg-slate-50\/50\b/g, replacement: 'bg-slate-800/50' },
    { regex: /\bbg-slate-200\/50\b/g, replacement: 'bg-slate-800/50' },
    { regex: /\bbg-slate-300\/50\b/g, replacement: 'bg-slate-700/50' },
    ...
    { regex: /\bborder-slate-300\b/g, replacement: 'border-slate-600' },
    { regex: /\bborder-gray-200\b/g, replacement: 'border-slate-700' },
    { regex: /\bdivide-slate-200\b/g, replacement: 'divide-slate-700' },
